               ...
               <div id="addRole" class="collapse in">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url() ?>User/save_user_data" autocomplete="off">
                           <div class="row">
                              <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                 <input class="form-control" name="mobile" id="mobile" pattern="[0-9]*" inputmode="numeric" minlength="10" maxlength="10" title="Please enter a valid Phone number" placeholder="Mobile" required>
                              ...
                              <div class="col-sm-6">
                                  <select class="form-control" name="role" id="role" required>
                                      ...
                                      <option value="<?php echo $getroleDetails->id ?>"><?php echo $getroleDetails->role_name  ?></option>
                                      <?php } ?>
                                  </select>
