...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <section id="item_section" name="item_section">
                ...
                <center>
                    <?php
                    if(isset($_SESSION['quotation_email_sent_message'])){
                    ?>
                        <p style="color:green"><?php echo $_SESSION['quotation_email_sent_message'];unset($_SESSION['quotation_email_sent_message']) ?></p>
                    <?php } ?>
                </center>
					...
					<div class="card">
						<div class="card-body">
							<center>
							      <?php
                                    if(isset($_SESSION['quotation_upload_heading_message'])){
                                    ?>
							    <p style="color:green"><?php echo $_SESSION['quotation_upload_heading_message'];unset($_SESSION['quotation_upload_heading_message']) ?></p>
                                <?php } ?>
                            </center>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                   ...
                                   <tbody>
                                    ...
                                    foreach($getAllQuotationsDetials as $key=>$getquotationDetails){ $key++;?>
                                        <tr id="quationsRow<?php echo $getquotationDetails->heading_id ?>">
                                            <td><?php echo $key; ?></td>
                                            ...
                                            <td>
                                              ...
                                              <td><?php echo date("d-m-Y",strtotime($getquotationDetails->created_datetime)) ?></td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary deletename" id="deleteButton" data-enquiryid="<?php echo $getquotationDetails->heading_id; ?>"><i class="fa fa-trash text-black"></i>  Delete</button>
    ...
    <script>
        ...
        $(document).on('click', 'button#deleteButton', function() {
            ...
            var actionUrl = "<?php echo base_url('Enquiry/deleteQuations'); ?>";
