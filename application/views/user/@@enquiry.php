                ...
                <div id="contact_persons" class="collapse in">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="Enquiry/save_contact_data" autocomplete="off">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input class="form-control" type="hidden" name="enquiry_id" id="enquiry_id" value="<?php echo $_GET['enquiry_id'] ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="landline" id="landline" placeholder="Landline No." required>
                                    </div>
                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="modal fade" id="editContact<?php echo $getcontactDetails->contact_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" >
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="Enquiry/edit_contact_data" autocomplete="off">
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <input class="form-control" name="mobile_no" id="mobile_no" value="<?php echo $getcontactDetails->mobile_no ?>" placeholder="Mobile No./Landline No." required>
                                                                                </div>
                                                                                <div class="col-sm-6">
